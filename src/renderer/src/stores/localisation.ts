...
const en = {
  ...
  memories: 'Memories',
  'memories-description': 'Persistent preferences and instructions shared by all agent sessions',
  'manage-memories': 'Manage memories',
  'memory-local-warning':
    'Memories are stored locally in plain text and sent with agent requests. Do not store passwords, API keys, tokens, or other secrets.',
  'add-memory': 'Add memory',
  'memory-placeholder': 'For example: Prefer concise explanations and TypeScript examples.',
  'no-memories': 'No memories saved yet.',
  'memory-created-by': 'Created by',
  'memory-updated': 'Updated',
  'delete-memory-confirm': 'Delete this memory?',
  refresh: 'Refresh',
  saving: 'Saving...',
  ...
  'target-user-option': 'Target User Option',
  'target-user-option-required': 'Choose a User option for the target',
  'no-user-options-hint': 'Add a User option to this slash command before using this action.',
  ...
  'showing-commands': 'Showing {shown} of {total} commands',
  'all-statuses': 'All Statuses',
  'filter-by-status': 'Filter by status',
  'sort-interactions': 'Sort interactions',
  'sort-registered-first': 'Registered',
  'sort-not-registered-first': 'Not Registered',
  'showing-interactions': 'Showing {shown} of {total} interactions',
...
const translations: Languages = {
  ...
  es: {
    ...
    'memory-created-by': 'Creada por',
    'memory-updated': 'Actualizada',
    'delete-memory-confirm': '¿Eliminar esta memoria?',
    refresh: 'Actualizar',
    saving: 'Guardando...',
  ...
  ja: {
    ...
    'memory-created-by': '作成者',
    'memory-updated': '更新日時',
    'delete-memory-confirm': 'このメモリを削除しますか？',
    refresh: '更新',
    saving: '保存中...',
    characters: '文字',
    language: '言語',
  ...
  zh: {
    ...
    'memory-created-by': '创建者',
    'memory-updated': '更新时间',
    'delete-memory-confirm': '删除这条记忆？',
    refresh: '刷新',
    saving: '保存中...',
    characters: '字符',
    language: '语言',
  ...
  ko: {
    ...
    'memory-created-by': '생성자',
    'memory-updated': '업데이트',
    'delete-memory-confirm': '이 메모리를 삭제할까요?',
    refresh: '새로 고침',
    saving: '저장 중...',
    characters: '자',
    language: '언어',
  ...
  ru: {
    ...
    'memory-created-by': 'Создано',
    'memory-updated': 'Обновлено',
    'delete-memory-confirm': 'Удалить эту запись?',
    refresh: 'Обновить',
    saving: 'Сохранение...',
    characters: 'символов',
    language: 'Язык',
