...
const en = {
    ...
    'quick-suggest-improvements': 'Analyze this command and suggest improvements to make it more effective, user-friendly, or feature-rich',
    ...
    'name-invalid-format': 'Must be 1-32 characters with letters, numbers, hyphens, underscores, or apostrophes',
...
const translations: Languages = {
  ...
  es: {
    ...
    'tip-shift-click-delete': 'Consejo: Mantén Shift y haz clic en el botón eliminar para omitir esta confirmación.',
    'open-quote': '"',
    'close-quote': '”',
    ...
    'quick-suggest-improvements': 'Analiza este comando y sugiere mejoras para hacerlo más efectivo, fácil de usar o con más características',
    ...
    'no-options-hint': 'Sin opciones. Añade opciones para permitir que los usuarios proporcionen entrada a tu comando.',
    ...
    'max-buttons-warning': 'Máximo 5 botones por fila. Discord limita los botones a 5 por fila de acción.',
    ...
    'name-invalid-format': 'Debe tener 1-32 caracteres con letras, números, guiones, guiones bajos o apóstrofes',
    ...
    type: 'Tipo',
    trigger: 'Disparador',
    'share-info': 'Tu comando estará disponible públicamente en el repositorio para que otros lo importen.',
  ...
  ja: {
    ...
    'tip-shift-click-delete': 'ヒント: Shiftキーを押しながら削除ボタンをクリックすると、この確認をスキップできます。',
    'open-quote': '「',
    'close-quote': '」',
    ...
    'quick-suggest-improvements': 'このコマンドを分析し、より効果的、ユーザーフレンドリー、または機能豊かにするための改善を提案してください',
    ...
    'add-option': 'オプションを追加',
    'no-options-hint': 'オプションがありません。オプションを追加してユーザーがコマンドに入力できるようにします。',
    'option-name': 'オプション名',
    ...
    'name-invalid-format': '1〜32文字で、文字、数字、ハイフン、アンダースコア、アポストロフィを使用してください',
  ...
  ko: {
    ...
    'tip-shift-click-delete': '팁: Shift 키를 누른 채 삭제 버튼을 클릭하면 이 확인을 건너뛸 수 있습니다.',
    'open-quote': '"',
    'close-quote': '"',
    'edit-command': '명령어 편집',
    ...
    'use-mentions': '멘션 사용',
    'add-counter': '카운터 추가',
    'quick-suggest-improvements': '이 명령을 분석하고 더 효과적이고 사용자 친화적이며 풍부한 기능을 갖추도록 개선 사항을 제안하세요',
    ...
    'add-option': '옵션 추가',
    'no-options-hint': '옵션이 없습니다. 사용자가 명령어에 입력을 제공할 수 있도록 옵션을 추가하세요.',
    'option-name': '옵션 이름',
    'option-type': '옵션 유형',
    'option-required': '필수',
    required: '필수',
  ...
  ru: {
    ...
    'tip-shift-click-delete': 'Совет: удерживайте Shift и нажмите кнопку удаления, чтобы пропустить это подтверждение.',
    'open-quote': '«',
    'close-quote': '»',
    ...
    'quick-suggest-improvements': 'Проанализируйте эту команду и предложите улучшения, чтобы сделать её более эффективной, удобной для пользователя или функциональной',
    ...
    'command-name-hint': 'Строчные буквы, без пробелов. Используйте буквы, цифры, дефисы, подчёркивания.',
    'command-description': 'Описание команды',
    'command-options': 'Параметры команды',
    'add-option': 'Добавить параметр',
    'no-options-hint': 'Нет параметров. Добавьте параметры, чтобы пользователи могли вводить данные.',
    ...
    'max-buttons-warning': 'Максимум 5 кнопок в ряд. Discord ограничивает кнопки до 5 на ряд действий.',
    ...
    'name-invalid-format': 'Должно быть 1-32 символа с буквами, цифрами, дефисами, подчёркиваниями или апострофами',
